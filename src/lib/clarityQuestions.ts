...
export const CLARITY_QUESTIONS: ClarityQuestion[] = [
  // SECCIÓN 1: IDENTIDAD (4 preguntas)
  {
    ...
    text: '¿Qué tan claro estás sobre quién eres como experta y cuál es tu misión de negocio?',
    type: 'scale',
    weight: 5,
  },
  {
  ...
  },
  {
    ...
    section: 'Identidad & Posicionamiento',
    sectionKey: 'identidad',
    text: '¿Cuán diferenciada está tu marca personal de otras coaches en tu nicho?',
    type: 'scale',
    weight: 5,
  },
  {
  ...
  },
  {
    ...
    section: 'Oferta & Programa',
    sectionKey: 'oferta',
    text: '¿Qué tan confiada te sientes de que tu precio refleja el valor real que entregas?',
    type: 'scale',
    weight: 5,
  },
  ...
  },
  {
    ...
    section: 'Ventas & Revenue',
    sectionKey: 'ventas',
    text: '¿Cuál fue tu ingreso bruto el mes pasado en tu negocio de coaching/consultoría?',
    type: 'select',
  ...
  },
  {
    ...
    section: 'Ventas & Revenue',
    sectionKey: 'ventas',
    text: '¿Qué tan cómoda te sientes en conversaciones de venta y cerrando clientes de alto valor?',
    type: 'scale',
    weight: 5,
  },
  {
  ...
  },
  {
    ...
    section: 'Mentalidad & Compromiso',
    sectionKey: 'mentalidad',
    text: '¿Qué tan lista estás para invertir tiempo, energía y recursos en tu crecimiento este trimestre?',
    type: 'scale',
    weight: 5,
  },
  {
